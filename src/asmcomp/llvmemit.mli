...
type llvm_instr =
  ...
  | Lswitch of string * llvm_instr * int list * llvm_instr list * llvm_type (* counter, expr, indexes, blocks, type *)
...
val translate_symbol : string -> string
...
val emit_llvm : llvm_instr -> Llvm.llvalue
